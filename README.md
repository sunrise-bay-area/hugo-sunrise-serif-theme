# Hugo Sunrise Serif Theme


Sunrise Serif Theme is a Hugo theme based on [Zerostatic's Serif Theme](https://www.zerostatic.io/theme/hugo-serif/).
...
```
cd mynewsite
git clone https://github.com/sunrise-bay-area/hugo-sunrise-serif-theme.git themes/hugo-sunrise-serif-theme
```

#### Install from .zip file

You can download the .zip file located here: TODO

Extract the downloaded .zip inside the `themes` folder. Rename the extracted folder from `hugo-sunrise-serif-theme-master` -> `hugo-serif-theme`. You should end up with the following folder structure `mynewsite/themes/hugo-sunrise-serif-theme`

### Add example content

Copy the entire contents of the `mynewsite/themes/hugo-sunrise-serif-theme/exampleSite/` folder to root folder of your Hugo site, ie `mynewsite/`

To copy the files using terminal, make sure you are still in the projects root, ie the `mynewsite` folder.

```
cp -a themes/hugo-sunrise-serif-theme/exampleSite/. .
```
...
baseURL = "/"
themesDir = "themes"
theme = "hugo-sunrise-serif-theme"
```
...
- Original Serif Theme by Robert Austin at https://www.zerostatic.io
